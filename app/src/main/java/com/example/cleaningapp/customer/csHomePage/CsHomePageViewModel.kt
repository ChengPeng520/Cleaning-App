...
class CsHomePageViewModel : ViewModel() {
    ...
    fun fetchCleaners() {
        ...
        list.add(Cleaner(1, R.drawable.cs_cleaner_img1,"曾正凡", true,2.1f, 1,"0911111111","台北市中正區重慶南路一段122號","我叫曾正凡，是補教業的名師，藝名是呂凡老師。我不教國中生，因為年紀太小的，我不喜歡被說爺孫戀，被我教過的學生英文都考一百分。"))
        list.add(Cleaner(2, R.drawable.cs_cleaner_img2,"呂正芃", true,3.5f, 3,"0922222222","台北市中正區中山南路1號","我叫呂正芃，多益875分，可以跟外籍雇主溝通，但是多語化服務要加錢。"))
        list.add(Cleaner(3, R.drawable.cs_cleaner_img3,"王睿睿", true,4.3f, 5,"0933333333","新北市三重區重新路三段145號","我叫王睿睿，住在新北市三重區，因為打架打不贏班上叼著菸的半甲哥，所以下課時間都去公園搶小朋友的溜滑梯，有一天一個小妹妹說我是穿著白衣服的壞男生，後來就再也沒有見過這個小妹妹。你問我他去哪裡了？我他媽怎麼會知道。"))
