...
class CsViewCvViewModel :ViewModel() {
    ...
    private fun updateComments() {
        ...
        commentList.add(Comment(1, "王睿睿",R.drawable.cs_cleaner_img2,112,2,4.9f,"蟑螂say goodbye"))
        commentList.add(Comment(1, "掰頂姊",R.drawable.cs_cleaner_img3,113,2,4.8f,"桌上少了10塊錢"))
        commentList.add(Comment(1, "隔壁老王",R.drawable.cs_cleaner_img4,114,2,0.5f,"小三的頭髮留在地板上沒掃到"))
