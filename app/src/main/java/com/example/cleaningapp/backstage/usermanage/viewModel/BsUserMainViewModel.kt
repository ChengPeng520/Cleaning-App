 ...
 * 使用者資料處理
 */
class BsUserMainViewModel : ViewModel() {
    //原始使用者列表
        ...
        if (newText == null || newText.isEmpty()) {
            ...
            userList.forEach { user ->
                if (user.name.contains(newText, true) ||
                    ...
                    user.createTime.contains(newText, true)
                ) {
    ...
    private fun loadUsers() {
        ...
        userList.add(
            User(
                "rona87@gmail.com", "P@ssw0rd", "Rona",
        ...
        userList.add(
            User(
                "ally87@gmail.com", "password", "Ally",
        ...
        userList.add(
            User(
                "ciyi87@gmail.com", "PASSWORD", "Ciyi",
