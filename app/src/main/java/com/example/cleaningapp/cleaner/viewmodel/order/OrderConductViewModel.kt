...
class OrderConductViewModel : ViewModel() {
    ...
    private fun loadOrders() {
        ...
        orderList.add(Work(R.drawable.cs_img_xxx,"11111111","2023年4月26日","12:00-14:00",
            "臺北市中山區南京東路三段219號5樓",5.0,5.0,5.0,5.0,
        "台北市中山區","工具:  吸塵器 、拖把\n" +
                    "整理重點:  臥房、客房 ", "1111元整"))

        orderList.add(Work(R.drawable.alb_account_avatar, "22222222", "2023年4月27日","13:00-15:00",
            "臺北市中山區南京東路三段219號6樓",5.0,5.0,5.0,5.0,
        "台北市中山區","工具:  吸塵器 、拖把\n" +
                    "整理重點:  臥房、客房 ","2222元整"))

        orderList.add(Work(R.drawable.alb_account_avatar, "33333333", "2023年4月28日","14:00-16:00",
